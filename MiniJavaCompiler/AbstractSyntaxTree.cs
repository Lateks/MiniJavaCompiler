...
namespace MiniJavaCompiler
{
    ...
    public abstract class BinaryOperator : SyntaxElement, Expression
    {
        ...
        public BinaryOperator(Expression lhs, Expression rhs, int row, int col)
            : base(row, col)
        {
            LHS = lhs;
            RHS = rhs;
    ...
    {
        public ArithmeticOp(Expression lhs, Expression rhs, int row, int col)
            : base(lhs, rhs, row, col) { }
    }

    public class LogicalOp : BinaryOperator
    {
        public LogicalOp(Expression lhs, Expression rhs, int row, int col)
            : base(lhs, rhs, row, col) { }
    }

    public class BooleanExpression : SyntaxElement, Expression
    {
        public bool Value
        {
            get;
        ...
        public BooleanExpression(bool value, int row, int col)
            : base(row, col)
        {
            Value = value;
        }
