...
\item The equal to operator ('==') accepts any type but both sides must be compatible with each other. Int, boolean and array types require that the other operand is of the same type. For user defined types subtypes are also allowed. % TODO
\end{itemize}
...
% note: static methods cannot be called because you cannot refer to the name of a class outside a type declaration or an instantiation
